        ...
        StringFileInfo(
            [
                StringTable(
                    "040904b0",
                    [
                        StringStruct("CompanyName", "The Android Open Source Project"),
                        StringStruct(
                            "FileDescription", "ADB Logcat Console Viewer"
                        ),  # Matches "File description"
                        StringStruct("FileVersion", "1.1.0"),  # Matches "File version"
